 ...
 */
final class Version20241208174250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entry (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, color VARCHAR(50) NOT NULL, shape VARCHAR(50) NOT NULL, images JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
